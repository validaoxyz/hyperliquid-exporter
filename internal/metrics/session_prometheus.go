...
var (
	HLNodeObservedRunLastActivitySeconds = promauto.NewGauge(prometheus.GaugeOpts{
	...
	HLNodeReplayLastActivitySeconds = promauto.NewGauge(prometheus.GaugeOpts{
	...
	HLNodeSnapshotHeightLagAvailable = promauto.NewGauge(prometheus.GaugeOpts{
